function Card(props) {
  return (
      <div className="rounded-lg shadow-lg p-3 h-full grid grid-cols-1">
          <div className="grid grid-cols-1 gap-4 h-full w-full  items-center justify-center">

              <img className="rounded-lg flex-grow object-cover object-center h-64" src={props.recipe.image} alt="veggies" />
